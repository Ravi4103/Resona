...
.bar-1 { animation: playing-bar-1 0.8s ease-in-out infinite; }
.bar-2 { animation: playing-bar-2 0.6s ease-in-out infinite; }
.bar-3 { animation: playing-bar-3 0.7s ease-in-out infinite; }
</style>
